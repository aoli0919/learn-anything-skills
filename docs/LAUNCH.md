...
Use this file when sharing the project.
...
比如具身智能：第一天不是读十篇论文，而是先画清楚 observation、action、policy、feedback 是怎么连起来的。
...
Use `assets/demo-terminal.svg` in the README and social posts.
