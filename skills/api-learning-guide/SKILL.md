---
name: "api-learning-guide"
description: "Guide beginners through an API with authentication, first request, response reading, errors, and next task."
---
...
- Guide beginners through an API with authentication, first request, response reading, errors, and next task.
