---
name: "math-gap-finder"
description: "Diagnose the exact math gap blocking a learner and build a small prerequisite repair path."
---
...
- Diagnose the exact math gap blocking a learner and build a small prerequisite repair path.
