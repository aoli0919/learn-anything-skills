---
name: "timebox-coach"
description: "Keep learning sessions bounded with time boxes, stop rules, fallback tasks, and visible outputs."
---
...
- Keep learning sessions bounded with time boxes, stop rules, fallback tasks, and visible outputs.
